        ...
        <div className="w-full space-y-16">
            ...
            <div className="w-full flex flex-col space-y-6">
                ...
                <table className="table_top">
                    <tbody>
                        <tr>
                            <td rowSpan={3} className="table_td border-l-0 text-center">기본할인</td>
                        ...
                        <tr>
                            ...
                            <td className="table_td">* 20인 이상<br />* 문화패스(청소년 및 대학생 8세~24세)</td>
                        </tr>
                        <tr>
                            <td className="table_td text-center">30%</td>
                            <td className="table_td">* 65세 이상(본인)<br />* 장애인(동반 1인 포함)<br />* 국가유공자(본인)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
